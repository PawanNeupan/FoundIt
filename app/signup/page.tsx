...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If email confirmation is ON, they must confirm first.
      setMessage("✅ Signup successful! Check your email to confirm, then login.")
      // Optional: send them to login after a moment
  ...
  const signInWithGoogle = async () => {
    setMessage(null)
    // Optional: if you use Google OAuth in Supabase
        ...
        >
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-muted-foreground">
              Choose your role and start using FoundIt
            </p>
          </div>
